...
static const char *tags[] = {
    "", /* tag:1  key:1  desc: terminal1 */
    "", /* tag:2  key:f  desc: firefox   */
    "", /* tag:3  key:i  desc: idea      */
    "", /* tag:4  key:g  desc: workspace */
    "", /* tag:5  key:m  desc: qqmusic   */
    "", /* tag:6  key:2  desc: terminal2 */
    "", /* tag:7  key:3  desc: terminal3 */
    "", /* tag:8  key:4  desc: terminal4 */
    "", /* tag:9  key:5  desc: terminal5 */
};
...
#define TAGKEYS(KEY, TAG, cmd)                                                                                                                                                                         \
  {MODKEY, KEY, view, {.ui = 1 << TAG, .v = cmd}}, {MODKEY | ControlMask, KEY, toggleview, {.ui = 1 << TAG}}, {MODKEY | ShiftMask, KEY, tag, {.ui = 1 << TAG}},
...
static const Key keys[] = {
  /* modifier            key        function        argument */
    ...
    {MODKEY,             XK_g,      setlayout,      {.v = &layouts[1]}                                   }, /* super + g              | 切换 grid 布局 */
    ...
    {Mod1Mask,           XK_space,  spawn,          SHCMD("~/Workspace/dotfiles/scripts/callRofi.sh run")}, /* alt + space | 打开 rofi */

    TAGKEYS(XK_1, 0, 0)  /* 切换到 tag 1 */
    TAGKEYS(XK_2, 1, "firefox")  /* 切换到 tag 2 */
    TAGKEYS(XK_3, 2, 0)  /* 切换到 tag 3 */
    TAGKEYS(XK_4, 3, 0)  /* 切换到 tag 4 */
    TAGKEYS(XK_5, 4, 0)  /* 切换到 tag 5 */
    TAGKEYS(XK_6, 5, 0)  /* 切换到 tag 6 */
    TAGKEYS(XK_7, 6, 0)  /* 切换到 tag 7 */
    TAGKEYS(XK_8, 7, 0)  /* 切换到 tag 8 */
    TAGKEYS(XK_9, 8, 0)  /* 切换到 tag 9 */
};
